...
class Server():
    def __init__(self, environment, filter, explore_noise, one_action,*args , **kwargs):
        ...
        self.serversocket.bind((self.dns_resolved_addr, 8020))
        self.server = SimpleXMLRPCServer(("0.0.0.0", 8020))
        ...
        self.save_model_dir = "save2"
        self.save_data_dir = "save_data2"
        self.save_eval_dir = "save_eval2"
