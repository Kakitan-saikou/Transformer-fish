...
import numpy as np
from server.agent_TD3 import Agent
from server.utils import KalmanFilter, NoneFilter
...
class Server():
    def __init__(self, environment, filter, explore_noise, one_action,*args , **kwargs):
        ...
        self.serversocket.bind((self.dns_resolved_addr, 8060))
        self.server = SimpleXMLRPCServer(("0.0.0.0", 8060))
        ...
        self.save_model_dir = "save6"
        self.save_data_dir = "save_data6"
        self.save_eval_dir = "save_eval6"
