...
class Server():
    def __init__(self, environment, filter, explore_noise, one_action,*args , **kwargs):
        ...
        self.serversocket.bind((self.dns_resolved_addr, 8030))
        self.server = SimpleXMLRPCServer(("0.0.0.0", 8030))
        ...
        self.save_model_dir = "save3"
        self.save_data_dir = "save_data3"
        self.save_eval_dir = "save_eval3"
